              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <input
                    ...
                    className={`px-4 py-3 bg-slate-800 border rounded-lg focus:outline-none transition-colors ${
            ...
            <div className="bg-slate-800/50 rounded-lg p-6 border border-slate-700">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">(+20) 155 032 8625</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-6 border border-slate-700">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">abdallahbs9393@gmail.com</p>
                </div>
              </div>
            </div>
